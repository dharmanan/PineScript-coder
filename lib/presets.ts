...
export const presets: StrategyConfig[] = [
  ...
  preset({ name: "RSI Divergence Reversal", entryTrigger: "trend_state", trend: { ...defaultConfig.trend, emaEnabled: false, vwapEnabled: false, longMaEnabled: false }, higherTimeframe: { ...defaultConfig.higherTimeframe, enabled: false }, momentum: { ...defaultConfig.momentum, divergenceEnabled: true, rsiLong: 40, rsiShort: 60 }, volume: { ...defaultConfig.volume, enabled: false } }),
